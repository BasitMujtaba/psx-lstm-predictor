...
PAKISTAN_ANCHOR = (
    ...
    r"|dawood[ ]hercules|ici[ ]pakistan|lotte[ ]chemical|sitara"
    r"|nishat|chenab|sapphire|service[ ]industries|sazgar|packages)\b"
)
...
CATEGORY_PATTERNS = {
    ...
    "banking": (
        ...
        r"|allied[ ]bank|habib[ ]metro|silk[ ]bank|bop[ ]bank"
    ...
    "corporates": (
        ...
        r"|colgate[ ]palmolive[ ]pakistan|abbott[ ]pakistan|searle"
        r"|highnoon|ferozsons|glaxo[ ]pakistan|ici[ ]pakistan"
        r"|indus[ ]motor|pak[ ]suzuki|millat[ ]tractor|al[ ]ghazi|sazgar"
        r"|gul[ ]ahmed|interloop|nishat|sapphire|chenab"
        r"|packages|security[ ]papers|unity[ ]foods|national[ ]foods|shezan"
        r"|pioneer[ ]cement|cherat|kohat[ ]cement|attock[ ]cement"
...
ARTICLE_URL_RE = re.compile(r"brecorder\.com/news/\d+")
TOTAL_WORKERS  = 6
USER_AGENTS    = [
